...
export const mockBlStates: BlState[] = [
  {
    ...
    currentFields: {
      ...
      overseasAgent: '',
      vessel: 'SOUL OF KOLKATA',
      voyage: '2610',
      placeOfReceipt: 'NHAVA SHEVA, INDIA',
      portOfLoading: 'NHAVA SHEVA, INDIA',
      placeOfDischarge: 'SOHAR PORT, OMAN',
      finalPlaceOfDelivery: 'SOHAR PORT, OMAN',
      blDate: '',
      shippedOnBoard: '',
      placeOfIssue: 'Mumbai',
      numberOfOriginals: '',
      blNumber: 'KLNSASOH000490',
      blNumberManual: '',
      movementType: 'CY/CY',
      blType: 'SURRENDER BL',
      shipmentReference: '',
      containers: 'TRLU3010904 20GP',
      packagesAndDescription: 'Razors and shaving accessories — 1x20 GP',
      weight: '',
      measurement: '',
      otherParticulars: '',
      freight: 'PREPAID',
  ...
  },
  {
    ...
    currentFields: {
      ...
      vessel: 'GFS PRECIOUS',
      voyage: '0050',
      placeOfReceipt: 'JEBEL ALI, UAE',
      portOfLoading: 'JEBEL ALI, UAE',
      placeOfDischarge: 'MUNDRA, INDIA',
      finalPlaceOfDelivery: 'MUNDRA, INDIA',
      blDate: '',
      shippedOnBoard: '',
      placeOfIssue: '',
      numberOfOriginals: '',
      ...
      blType: '',
      shipmentReference: '',
      containers: 'CGMU9299220 40RF',
      packagesAndDescription: 'Foodstuff — 1x40 RF (reefer)',
      weight: '',
      measurement: '',
      otherParticulars: '',
      freight: '',
